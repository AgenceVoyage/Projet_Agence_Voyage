...
public class LoginController {
	...
	/**
	 * Methode permettant de rediriger l'agent si il n'est pas autorisé à acceder à l'application
	...
	/**
	 * Methode permettant de rediriger si l'authentification de l'agent à échoué.
	 * Le message d'erreur informe l'agent que son mail ou mdp sont incorrect.
	 * @param modele
	 * @return la page login.jsp
	 */
