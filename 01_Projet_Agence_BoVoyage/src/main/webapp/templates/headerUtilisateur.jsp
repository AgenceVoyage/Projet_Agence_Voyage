...
<nav class="navbar navbar-inverse" style="background-color: #F8F8F8;">
  <div class="container-fluid">
    <ul class="nav navbar-nav">
      ...
      <li><a href="${pageContext.request.contextPath}/utilisateur/accueil">Accueil</a></li>
			...
			<li class="dropdown">
     		 ...
     		 <li><a href="${pageContext.request.contextPath}/utilisateur/client/afficheAjout">Inscription Client</a></li>
